...
if __name__ == "__main__":
    ...
    warm_fold = create_fold(df, args.SEED, [0.7, 0.1, 0.2])
    warm_fold["train"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/warm/" + "fold_"+str(args.FOLD)+"_train.csv", index=False)
    warm_fold["valid"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/warm/" + "fold_"+str(args.FOLD)+"_valid.csv", index=False)
    warm_fold["test"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/warm/" + "fold_"+str(args.FOLD)+"_test.csv", index=False)
    ...
    cold_target_fold = create_fold_setting_cold(df, args.SEED, [0.7, 0.1, 0.2], ['target_key'])
    cold_target_fold["train"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-prot/" + "fold_"+str(args.FOLD)+"_train.csv", index=False)
    cold_target_fold["valid"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-prot/" + "fold_"+str(args.FOLD)+"_valid.csv", index=False)
    cold_target_fold["test"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-prot/" + "fold_"+str(args.FOLD)+"_test.csv", index=False)
    ...
    cold_drug_fold = create_fold_setting_cold(df, args.SEED, [0.7, 0.1, 0.2], ['drug_key'])
    cold_drug_fold["train"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-drug/" + "fold_"+str(args.FOLD)+"_train.csv", index=False)
    cold_drug_fold["valid"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-drug/" + "fold_"+str(args.FOLD)+"_valid.csv", index=False)
    cold_drug_fold["test"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-drug/" + "fold_"+str(args.FOLD)+"_test.csv", index=False)
    ...
    cold_target_drug_fold = create_fold_setting_cold(df, args.SEED, [0.7, 0.1, 0.2], ['target_key', 'drug_key'])
    cold_target_drug_fold["train"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-pair/" + "fold_"+str(args.FOLD)+"_train.csv", index=False)
    cold_target_drug_fold["valid"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-pair/" + "fold_"+str(args.FOLD)+"_valid.csv", index=False)
    cold_target_drug_fold["test"].to_csv("./MMPKAN-DTA/datasets/" + args.dataset + "/novel-pair/" + "fold_"+str(args.FOLD)+"_test.csv", index=False)
