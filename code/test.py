...
model_fromTrain =  './MMPKAN-DTA/savemodel/trained_weight_model.pth'
...
test_dir = './MMPKAN-DTA/datasets/kiba/warm/fold_1_test.csv'
test_set = CustomDataSet(pd.read_csv(test_dir, sep=','), hp)
test_dataset_load = DataLoader(test_set, batch_size=hp.Batch_size, shuffle=False, drop_last=True, num_workers=0, collate_fn=lambda x: my_collate_fn(x, device, hp, drug_df, prot_df, mol2vec_dict, protvec_dict, contact_map))
