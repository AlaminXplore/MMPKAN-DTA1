...
def get_chem_pretrain(df_dir, db_name, max_smiles_length=220):
    ...
    # Save embeddings
    output_path = f'./MMPKAN-DTA/datasets/pretrained/{db_name}/{db_name}_chem_pretrained.pkl'
...
df_dirs = [r'./MMPKAN-DTA/datasets/davis/davis_drugs.csv', r'./MMPKAN-DTA/datasets/kiba/kiba_drugs.csv', r'./MMPKAN-DTA/datasets/metz/metz_drugs.csv', r'./MMPKAN-DTA/datasets/bindingDB/bindingDB_drugs.csv']
